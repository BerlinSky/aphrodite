...
(0, _jquery2.default)(function () {
	...
	function setNewsContentTopPosition() {
		var mainContainer = (0, _jquery2.default)('.mainContainer');
		var mainContainerParentHeight = mainContainer.parent().height();
		var newsContent = (0, _jquery2.default)('.chamberContainer__content');
	...
	(0, _jquery2.default)('[data-mobileMenu="close"]').click(function () {
		(0, _jquery2.default)('html, body').on('touchmove', function (e) {
			return true;
		});
...
},{"./Plate":4,"./RotationCalculator":5,"imagesLoaded":2,"jquery":3}]},{},[6])
